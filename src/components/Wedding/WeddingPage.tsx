      ...
      <div className="text-center">
        <div className="mb-4">
          ...
          <a href="https://react.dev" target="_blank" rel="noopener noreferrer">
            <img src={reactLogo} className="logo react" alt="React logo" style={{height: '6em'}} />
          </a>
        </div>
        ...
        <div className="card mx-auto" style={{maxWidth: '400px'}}>
          <div className="card-body">
            ...
            <Accordion>
              {(can ? canTxns : txns).map((txn, idx) => (
                <Accordion.Item eventKey={String(idx)} key={(can ? (txn as CanItem).canItemId : (txn as Item).itemId) || idx} className={styles.customAccordionItem}>
                  <Accordion.Header>
                     {can ? <>&#36;</> : <>&#8364;</>}{txn.price} 
                  </Accordion.Header>
                  <Accordion.Body>
                    <Card
                      key={(txn as Item).itemId || idx}
                      className="w-100 p-0"
                      border="primary"
                      ...
                      <Card.Body>
                        <Card.Text>
                          <i className="bi bi-trash3" style={{ float: 'right', cursor: 'pointer' }}
                            onClick={() => {
                              const itemId = can ? (txn as CanItem)?.canItemId : (txn as Item)?.itemId;
